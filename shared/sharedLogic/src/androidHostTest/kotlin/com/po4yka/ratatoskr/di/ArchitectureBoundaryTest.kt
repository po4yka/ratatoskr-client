...
class ArchitectureBoundaryTest {
    ...
    fun `all platform bootstraps list the same split modules`() {
        ...
        val bootstrapFiles =
            listOf(
                repoRoot.resolve(
                    "shared/sharedLogic/src/androidMain/kotlin/com/po4yka/ratatoskr/di/KoinInitializer.kt",
                ),
                repoRoot.resolve(
                    "shared/sharedLogic/src/desktopMain/kotlin/com/po4yka/ratatoskr/di/KoinInitializer.kt",
                ),
                repoRoot.resolve(
                    "shared/sharedLogic/src/iosArm64Main/kotlin/com/po4yka/ratatoskr/di/IosCommonModules.kt",
                ),
                repoRoot.resolve(
    ...
    fun `appModules aggregates generated and binding modules`() {
        ...
        val content =
            repoRoot
                .resolve("shared/sharedLogic/src/commonMain/kotlin/com/po4yka/ratatoskr/di/AppModules.kt")
                .readText()
