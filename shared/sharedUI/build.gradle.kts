...
kotlin {
    cocoapods {
        ...
        framework {
            ...
            //   - ComposeRootViewControllerFactory lives in this module
            //     → no export needed for the symbol itself.
            //   - IosAppHost, IosKoinBootstrap, RootComponent live in
            //     shared/sharedLogic → exported below so Swift sees
            //     them through the same ComposeApp framework.
            ...
            export(projects.shared.sharedLogic)
    ...
    sourceSets {
        commonMain.dependencies {
            api(projects.shared.sharedLogic)
