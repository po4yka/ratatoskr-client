...
interface RssRepository {
    ...
    suspend fun subscribe(url: String, categoryId: Int? = null): RssFeedSubscription

    suspend fun unsubscribe(subscriptionId: Int)

    suspend fun listFeedItems(feedId: Int, limit: Int = 20, offset: Int = 0): List<RssFeedItem>
