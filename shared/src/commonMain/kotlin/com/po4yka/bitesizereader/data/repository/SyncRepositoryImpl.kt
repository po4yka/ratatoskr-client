...
class SyncRepositoryImpl(
    ...
    override fun performFullSync(): Flow<SyncState> = flow {
        if (isSyncing) {
    ...
    override fun performDeltaSync(): Flow<SyncState> = flow {
        if (isSyncing) {
        ...
        try {
            ...
            val lastSync = getLastSyncTimestamp() ?: run {
    ...
    override fun uploadLocalChanges(): Flow<SyncState> = flow {
