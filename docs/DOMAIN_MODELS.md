...
Shared immutable models live in `core/common/src/commonMain/kotlin/com/po4yka/ratatoskr/domain/`. Feature-owned public contracts live beside their owning feature in `feature/<name>/.../api` or `.../domain`.
