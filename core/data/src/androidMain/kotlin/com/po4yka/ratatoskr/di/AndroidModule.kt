...
import com.po4yka.ratatoskr.data.local.AndroidSecureStorage
...
import com.po4yka.ratatoskr.util.network.AndroidNetworkMonitor
import com.po4yka.ratatoskr.util.network.NetworkMonitor
import com.po4yka.ratatoskr.util.share.AndroidShareManager
...
class AndroidModule {
    ...
    @Single
    fun providePlatform(): com.po4yka.ratatoskr.Platform = com.po4yka.ratatoskr.AndroidPlatform()

    @Single
    fun provideAudioPlayer(): com.po4yka.ratatoskr.util.audio.AudioPlayer =
        com.po4yka.ratatoskr.util.audio.AudioPlayer()
}
