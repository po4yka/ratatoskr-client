...
object AppConfig {
    ...
    object App {
        ...
        const val NAME = "Ratatoskr Client"

        /** App package/bundle identifier */
        const val PACKAGE_ID = "com.po4yka.ratatoskr"

        /** App version (should match build.gradle.kts) */
        const val VERSION = "0.1.0"

        /** Client identifier for API authentication */
        var clientId: String = "ratatoskr-android-v1.0"

        /** Support email */
        const val SUPPORT_EMAIL = "support@ratatoskr.example.com"

        /** Website URL */
        const val WEBSITE_URL = "https://ratatoskr.example.com"
    }

    /** Database Configuration */
    object Database {
        /** Database file name used across all platforms */
        const val NAME = "ratatoskr.db"
    }
