...
internal object ArchitectureBoundaryRules {
    ...
    private val allowedComposeAppUiPaths =
        setOf(
            "composeApp/src/commonMain/kotlin/com/po4yka/bitesizereader/ui/screens/MainScreen.kt",
        )
    ...
    fun findShellRouteUiImportViolations(shellFiles: List<SourceFile>): List<String> =
        shellFiles.flatMap { file ->
            scanImports(file.content)
                .filter { it.startsWith("com.po4yka.bitesizereader.feature.") }
    ...
    fun isAllowedDirectDiPath(path: String): Boolean =
        path == "composeApp/src/commonMain/kotlin/com/po4yka/bitesizereader/App.kt" ||
            ...
            path == "composeApp/src/iosMain/kotlin/com/po4yka/bitesizereader/IosAppHost.kt" ||
            path.contains("/di/") ||
