...
Guidance for UI work in `composeApp/`. Applies to Claude Code, Codex, and
any other AGENTS.md-aware agent.

## Module Role

- `composeApp` contains the shell navigation layer, iOS CocoaPods export,
  and the desktop dev target.
...
- Route screens and feature-specific UI live in the owning `feature/*`
  module.
- `composeApp` UI should stay limited to the shell host and adaptive
  navigation chrome.
