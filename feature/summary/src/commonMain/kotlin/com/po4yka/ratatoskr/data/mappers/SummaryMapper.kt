...
private fun com.po4yka.ratatoskr.data.remote.dto.QualityAssessmentDto.toDomain(): SummaryQuality {
...
private fun com.po4yka.ratatoskr.data.remote.dto.InsightsDto.toDomain(): SummaryInsights {
...
private fun com.po4yka.ratatoskr.data.remote.dto.InsightFactDto.toDomain(): InsightFact {
    return InsightFact(
        fact = fact,
